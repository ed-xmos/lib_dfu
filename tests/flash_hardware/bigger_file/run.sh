...
# expected 1052672 = 1MB data partition base + 4KB for sector-padded hardware build section + 4KB for sector-padded data factory image
...
xrun --io --args bin/bigger_file.xe 1056768
