...
data_partition_generator --regular-sector-size 4096 --hardware-build 0x12345678 -o /tmp/factory.bin --factory /tmp/factory.json || exit $?
...
xrun --xscope --args bin/time_write_upgrade.xe ../hello_world.bin /tmp/upgrade.bin 1000000 || exit $?
