...
data_partition_generator --regular-sector-size 4096 -o /tmp/factory.bin --factory factory.json || exit $?
...
for block_size in 32 128 256 512 ; do
  ...
  xrun --io --args bin/write_upgrade_data_only.xe /tmp/upgrade.bin $block_size 1056768 || exit $?
done
